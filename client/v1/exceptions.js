...
function CheckpointError(json, session, uuid) {
  ...
  if (
    !this.url &&
    _.isObject(json.checkpoint) &&
    _.isString(json.checkpoint.url)
  )
...
// const two_factor_example = {
//   message: "",
//   two_factor_required: true,
//   two_factor_info: {
//     username: "alexey906090",
//     sms_two_factor_on: true,
//     totp_two_factor_on: false,
//     obfuscated_phone_number: "1941",
//     two_factor_identifier: "phtROsg9Mr",
...
function TwoFactorError(json, session) {
  ...
  if (
    ...
    _.isString(json.two_factor_info.two_factor_identifier)
  )
    this.two_factor_identifier = json.two_factor_info.two_factor_identifier;

  if (
    _.isObject(json.two_factor_info) &&
    _.isString(json.two_factor_info.obfuscated_phone_number)
  )
    this.obfuscated_phone_number = json.two_factor_info.obfuscated_phone_number;

  this.session = session;
}

util.inherits(TwoFactorError, APIError);
